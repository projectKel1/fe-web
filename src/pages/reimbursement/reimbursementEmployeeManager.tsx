...
const ReimbursementEmployeeManager = () => {
  ...
  const getData = async () => {
    axios
      .get(`https://node.flattenbot.site/request-reimbursement`, {
        headers: {
                ...
                {data
                  ? data.map((element, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{element.keterangan}</td>
                        <td className="px-6 py-4">{element.jenis}</td>
                        <td className="px-6 py-4">12/01/2023</td>
