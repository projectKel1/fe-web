...
const ReimbursementHrEmployee = () => {
    return (
        <div className="p-10 h-full bg-bgMain">
          <div className="py-2">
            <CardReimbursement tittle="Reimbursement HR Employee" subTittle="Check Reimbursement here" />
          </div>
...
export default ReimbursementHrEmployee